...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @endif
        {!! Form::open(['route' => ['skkapersmt14store', session()->get('simpanid')]]) !!}
        <section class="content">
            <div class="box box-default">
                <div class="box-body">
                    <div class="form-group">
                        <label>Komunikasi antar atasan dan bawahan di kantor saya menyenangkan.</label>
                    ...
                    <div class="form-group">
                        <label>Komunikasi antar rekan kerja di kantor saya menyenangkan.</label>
                        <div class="input-group">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        <label>Pendelegasian kewenangan dan tanggung jawab di kantor ini jelas bagi saya.</label>
                        <div class="input-group">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        <label>Goals / tujuan (sasaran) yang ingin dituju oleh kantor ini jelas bagi saya.</label>
                        <div class="input-group">
                            <div class="input-group">
