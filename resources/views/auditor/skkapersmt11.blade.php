...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @endif
        {!! Form::open(['route' => ['skkapersmt10store', session()->get('simpanid')]]) !!}
        <section class="content">
            <div class="box box-default">
                <div class="box-body">
                    <div class="form-group">
                        <label>Keterbatasan alokasi waktu yang diberikan (budget time) merupakan beban yang berat bagi saya.</label>
                    ...
                    <div class="form-group">
                        <label>Keterbatasan alokasi waktu audit tidak mengurangi kualitas pekerjaan saya.</label>
                        <div class="input-group">
                            <div class="input-group">
                    ...
                    <div class="form-group">
                        <label>Keterbatasan alokasi waktu dapat mengganggu proses pekerjaan yang seharusnya saya lakukan.</label>
                        <div class="input-group">
                            <div class="input-group">
