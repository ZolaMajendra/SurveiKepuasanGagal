                    ...
                    <div class="box">
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>Persepsi Manajemen Terhadap SPI</td>
                                    <td>{{$hasil->persepsi}}</td>
                                </tr>
                                <tr>
                                    <td>Staff Audit Internal</td>
                                    <td>{{$hasil->internal}}</td>
                                </tr>
                                <tr>
                                    <td>Ruang Lingkup Pekerjaan Audit</td>
                                    <td>{{$hasil->lingkup}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>Proses dan Laporan Audit</td>
                                    <td>{{$hasil->proses}}</td>
                                </tr>
                                <tr>
                                    <td>Total</td>
                        ...
                        <div class="box-footer" align="center">
                            <a href="{{ route('tAuditee') }}" class="btn btn-primary">Export to Excel</a>
                        </div>
                    </div>
                </div>
            </div>
