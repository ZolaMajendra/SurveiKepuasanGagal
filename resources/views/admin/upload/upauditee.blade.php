...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    {!! Form::open(['route' => 'storeFileAuditee', 'method' => 'POST','files' => 'true']) !!}
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <div class="box-title">Berkas yang Telah di Upload</div>
                        </div>
                                ...
                                @foreach($file as $data)
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="{{ route('destFileAuditee', $data->id_berkas) }}" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
