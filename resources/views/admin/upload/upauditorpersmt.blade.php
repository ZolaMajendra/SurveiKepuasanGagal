...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    {!! Form::open(['route' => 'storeFileAuditor2', 'method' => 'POST','files' => 'true']) !!}
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                {!! Form::label('unit_spi', 'Kantor SPI Regional', ['class' => 'control-label']) !!}
                                ...
                                @foreach($file as $data)
                                    <tr>
                                        ...
                                        <td align="center">
                                            ...
                                            <a href="{{ route('destFileAuditor2', $data->id_berkas) }}" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
