            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            {!! Form::open(['route' => 'admAuditor2Filter']) !!}
                            <div class="col-md-6">
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <div class="box-title">Auditor yang Sudah Mengisi SKKA per Semester</div>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                @foreach($data as $dat)
                                    <tr>
                                        ...
                                        <td>{{$dat->tahun}}</td>
                                        <td>
                                            <a href="{{ route('showAuditor2Id', $dat->id_identitas) }}" class="btn btn-primary">Lihat Hasil</a>
                                            <a href="{{ route('deleteAuditor2', $dat->id_identitas) }}" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                        ...
                        <div class="box-footer" align="center">
                            <a href="{{ route('IdAuditorsmt') }}" class="btn btn-primary">Export to Excel</a>
                        </div>
                    </div>
                </div>
            </div>
