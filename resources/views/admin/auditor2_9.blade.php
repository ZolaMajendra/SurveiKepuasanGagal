                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$pil4['pil4ts']}}</td>
                                    <td>{{$pil4['pil4sts']}}</td>
                                    <td>{{(($pil4['pil4ss']*5)+($pil4['pil4s']*4)+($pil4['pil4ks']*3)+($pil4['pil4ts']*2)+($pil4['pil4sts']*1))/($pil1['pilcount']*5)}}</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    ...
                                    <td>{{$pil5['pil5ts']}}</td>
                                    <td>{{$pil5['pil5sts']}}</td>
                                    <td>{{(($pil5['pil5ss']*5)+($pil5['pil5s']*4)+($pil5['pil5ks']*3)+($pil5['pil5ts']*2)+($pil5['pil5sts']*1))/($pil1['pilcount']*5)}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="box-footer" align="center">
                            <a href="{{ route('cont9Auditorsmt') }}" class="btn btn-primary">Export to Excel</a>
                        </div>
                    </div>
                </div>
            </div>
