                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-footer" align="center">
                            <a href="{{ route('ksAuditorsmt') }}" class="btn btn-primary">Export to Excel</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="box">
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td>Pelatihan dan Kompetensi</td>
                                    <td>{{$hasil->pelatihan}}</td>
                                </tr>
                                <tr>
                                    <td>Komitmen Organisasional</td>
                                    <td>{{$hasil->organisasional}}</td>
                                </tr>
                                <tr>
                                    <td>Komitmen Profesional</td>
                                    <td>{{$hasil->profesional}}</td>
                                </tr>
                                <tr>
                                    <td>Motivasi Kerja</td>
                                    <td>{{$hasil->motivasi}}</td>
                                </tr>
                                <tr>
                                    <td>Konflik Peran</td>
                                    <td>{{$hasil->konflik}}</td>
