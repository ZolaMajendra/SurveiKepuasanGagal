                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$k1a['k1ats']}}</td>
                                    <td>{{$k1a['k1asts']}}</td>
                                    <td>{{(($k1a['k1ass']*5)+($k1a['k1as']*4)+($k1a['k1aks']*3)+($k1a['k1ats']*2)+($k1a['k1asts']*1))/($k1a['k1acount']*5)}}</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    ...
                                    <td>{{$k1b['k1bts']}}</td>
                                    <td>{{$k1b['k1bsts']}}</td>
                                    <td>{{(($k1b['k1bss']*5)+($k1b['k1bs']*4)+($k1b['k1bks']*3)+($k1b['k1bts']*2)+($k1b['k1bsts']*1))/($k1a['k1acount']*5)}}</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    ...
                                    <td>{{$k1c['k1cts']}}</td>
                                    <td>{{$k1c['k1csts']}}</td>
                                    <td>{{(($k1c['k1css']*5)+($k1c['k1cs']*4)+($k1c['k1cks']*3)+($k1c['k1cts']*2)+($k1c['k1csts']*1))/($k1a['k1acount']*5)}}</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    ...
                                    <td>{{$k1d['k1dts']}}</td>
                                    <td>{{$k1d['k1dsts']}}</td>
                                    <td>{{(($k1d['k1dss']*5)+($k1d['k1ds']*4)+($k1d['k1dks']*3)+($k1d['k1dts']*2)+($k1d['k1dsts']*1))/($k1a['k1acount']*5)}}</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    ...
                                    <td>{{$k1e['k1ets']}}</td>
                                    <td>{{$k1e['k1ests']}}</td>
                                    <td>{{(($k1e['k1ess']*5)+($k1e['k1es']*4)+($k1e['k1eks']*3)+($k1e['k1ets']*2)+($k1e['k1ests']*1))/($k1a['k1acount']*5)}}</td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    ...
                                    <td>{{$k1f['k1fts']}}</td>
                                    <td>{{$k1f['k1fsts']}}</td>
                                    <td>{{(($k1f['k1fss']*5)+($k1f['k1fs']*4)+($k1f['k1fks']*3)+($k1f['k1fts']*2)+($k1f['k1fsts']*1))/($k1a['k1acount']*5)}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="box-footer" align="center">
                            <a href="{{ route('cont1Auditorsmt') }}" class="btn btn-primary">Export to Excel</a>
                        </div>
                    </div>
                </div>
            </div>
